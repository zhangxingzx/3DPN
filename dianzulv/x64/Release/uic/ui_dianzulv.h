...
public:
    ...
    void setupUi(QMainWindow *dianzulvClass)
    {
        ...
        lineEditpn = new QLineEdit(centralWidget);
        lineEditpn->setObjectName(QString::fromUtf8("lineEditpn"));
        lineEditpn->setGeometry(QRect(440, 10, 51, 20));
        ...
        widget_2->setGeometry(QRect(520, 40, 661, 341));
        label_8 = new QLabel(centralWidget);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setGeometry(QRect(1010, 10, 54, 12));
